...
[tnpm-image]: https://npm.alibaba-inc.com/badge/v/mammoth-styled.svg
[tnpm-url]: https://npm.alibaba-inc.com/package/mammoth-styled
[tnpm-downloads-image]: https://npm.alibaba-inc.com/badge/d/mammoth-styled.svg

--------------------

### 将 docx 文件转换为 html 文件，并以内联样式的形式保留 docx 中的样式
